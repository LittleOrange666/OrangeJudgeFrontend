<template>
    <div>
        ...
        <div class="container-fluid">
            ...
            <form @submit.prevent="choose_checker">
        ...
        <div class="container-fluid">
            ...
            <form @submit.prevent="choose_interactor">
        ...
        <div class="container-fluid">
            <h4>固定主程式</h4>
            <form @submit.prevent="choose_runner">
                <div class="form-check form-switch">
        ...
        <div class="container-fluid">
            <h4>範例程式</h4>
            <form @submit.prevent="choose_sample">
                <div class="row" v-for="(lang,i) in lang_info" :key="i">
                    <div class="col-auto">
                        <p>{{ lang.name }}: </p>
                    </div>
        ...
        <div class="container-fluid">
            ...
            <div class="row" v-for="(file,i) in data.data.library" :key="i">
                ...
                <div class="col-auto">
                    <button class="btn btn-danger" v-on:click="deleteLibrary(file)">刪除</button>
                </div>
            </div>
        ...
        <div class="container-fluid">
            ...
            <form @submit.prevent="choose_codechecker">
                ...
                <button class="btn btn-primary" :disabled="my_codechecker=='unknown'&&codechecker_type!='disabled'">儲存程式碼檢查器設定</button>
            </form>
        </div>
    </div>
</template>
